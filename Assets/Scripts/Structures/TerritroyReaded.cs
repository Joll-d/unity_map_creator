...
public class TerritroyReaded
{
    ...
    public TerritroyReaded(Transform transform)
    {
        ...
        Index = XPosition.ToString(CultureInfo.InvariantCulture) + "_" + YPosition.ToString(CultureInfo.InvariantCulture) + "_" + ZPosition.ToString(CultureInfo.InvariantCulture);
