...
public class MatrixMap
{
    ...
    public bool ContainsVertexByPox(Vector3 vector, out TerritroyReaded game)
    {
        ...
        string index = vector.x.ToString(CultureInfo.InvariantCulture) + "_" + vector.y.ToString(CultureInfo.InvariantCulture) + "_" + vector.z.ToString(CultureInfo.InvariantCulture);
    ...
    public string MakeFromVector3ToIndex(Vector3 vector) => (vector.x.ToString(CultureInfo.InvariantCulture) + "_" + vector.y.ToString(CultureInfo.InvariantCulture) + "_" + vector.z.ToString(CultureInfo.InvariantCulture));
